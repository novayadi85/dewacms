var apps = angular.module('page', ['datatables']);
...
var content ;
	...
	apps.controller('pages', ['$scope', '$http', '$location', '$window', function ($scope, $http , $location ,$window) {
		...
		$scope.options = {
			...
			allowedContent: true,
			entities: false,
			filebrowserUploadUrl: '/admin/plugins/ckfinder/core/connector/php/connector.php?opener=ckeditor&type=files',
			filebrowserImageUploadUrl: '/admin/plugins/ckfinder/core/connector/php/connector.php?opener=ckeditor&type=images'
		};
