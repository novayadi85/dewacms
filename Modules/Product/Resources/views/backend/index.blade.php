...
@section('content')
	...
	@endif
	<div class="" ng-app="product" ng-controller="products" ng-init="view='list'"> 
	<div class="block">
		<div class="btn-group">
			<a href="{{Route('product.create')}}" class="btn blue" title="Add New">Create New</a>
		</div>
